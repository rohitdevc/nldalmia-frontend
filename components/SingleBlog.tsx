    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="w-full">
                <Image src={blog.blog_thumbnail || `${basePath}logo.svg`} alt={blog.blog_thumbnail_alt || blog.blog_title} width={600} height={600} className="object-cover w-full h-full" />
            </div>
            <h2 className="font-georgia text-xl">{blog.blog_title}</h2>
