...
export function FacultyCard({faculty, keyIndex}: FacultyProps) {
    ...
    return (
        <div className="flex flex-col gap-4 xl:w-sm justify-center items-center text-center bg-white border-[0.5px] border-[#E0CDCD]" title={faculty.faculty_name} key={keyIndex}>
            <div className="h-75">
                {
