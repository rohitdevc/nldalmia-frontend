        ...
        }
        {
          program.program_highlights && program.program_highlights.length > 0 && (
            <div className="flex flex-col gap-2">
              ...
              <ul className="flex flex-col gap-3 text-base text-[#4E4E4E] list-disc list-outside">
                {
        ...
        }
        {
          program.program_career_paths && program.program_career_paths.length > 0 && (
            <div className="flex flex-col gap-2">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3 xl:gap-5 text-base text-[#4E4E4E] list-disc list-outside">
                {
