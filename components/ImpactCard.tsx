...
export const ImpactCard = ({ impact }: Props) => {
  ...
  return (
    <div ref={ref} className="bg-[#FFCC33] py-5 w-full lg:min-h-50 px-2 flex flex-col justify-center items-center text-center gap-5 transition-all duration-300 ease-in-out hover:lg:-mt-5">
