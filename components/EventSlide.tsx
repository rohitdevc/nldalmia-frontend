...
export default function EventSlide({event_slider}: Props) {
    ...
    return (
        <div className="w-full aspect-video sm:h-[300px] lg:h-[75vh] relative bg-contain sm:bg-cover bg-center bg-no-repeat flex px-5 lg:px-10 sm:py-10 cursor-pointer" style={{backgroundImage: `url(${event_slider.event_slider_image || `https://img.youtube.com/vi_webp/${event_slider.event_slider_video}/0.webp`})`}} onClick={() => videoPopupRef.current?.open(event_slider.event_slider_video)}>
            {
