                      ...
                      <div className="flex flex-col gap-5">
                        ...
                        }
                        {
                          international_partner.program_international_partner_description && (
                            <p className="h-40 overflow-y-auto scrollbar-thin hover:scrollbar-thumb-black/40">{parser(nl2br(international_partner.program_international_partner_description))}</p>
                          )
                        }
                      </div>
                    </div>
