...
import FacultyComponent from "@/components/pages/FacultyComponent";

const [ meta, banner ] = await Promise.all([ getMetaData("Faculty"), getBanner("Faculty") ]);
...
export default async function Page() {
  return (
    <FacultyComponent banner={banner} />
  )
}
